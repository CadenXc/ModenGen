...
#include "ProceduralMeshComponent.h" // 确保包含这个头文件
#include "ChamferCube.generated.h"

UCLASS()
class CHAMFEREDCUBE_API AChamferCube : public AActor
{
	GENERATED_BODY()
...
public:	
    ...
    // !!! 将 GenerateChamferedCube 标记为蓝图可调用 !!!
