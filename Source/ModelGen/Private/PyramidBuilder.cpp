...
{
    TArray<FVector> BaseVerts = GenerateCircleVertices(Params.GetBevelTopRadius(), 0.0f, Params.Sides);
...
void FPyramidBuilder::GenerateBevelSection()
{
    ...
    TArray<FVector> BevelBottomVerts = GenerateCircleVertices(Params.GetBevelTopRadius() , 0.0f, Params.Sides);
    TArray<FVector> BevelTopVerts = GenerateCircleVertices(Params.GetBevelTopRadius(), BevelHeight, Params.Sides);
    
    GenerateSideStrip(BevelBottomVerts, BevelTopVerts, true, 0.0f, 1.0f);
}

void FPyramidBuilder::GeneratePyramidSides()
{
    const float PyramidBaseRadius = Params.GetBevelTopRadius();
